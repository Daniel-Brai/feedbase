...
class RenameFeedSubscriptionForm(BaseForm):
    """
    Form for renaming feed subscriptions
    """

    title: Annotated[str, StringConstraints(min_length=2, max_length=500, strip_whitespace=True)] = FormField(
        "text",
        html_attrs={
            "required": "required",
            "minlength": "2",
    ...
    form_config = FormConfigDict(
        swap="none",
        submit_url="/api/v1/subscriptions/{subscription_id}",
        submit_method="PATCH",
        submit_context=SubmitContext(
            success=FormSubmissionSuccessContext(
                ...
                context={
                    "type": "success",
                    "message": "forms.rename_feed_subscription.success_msg",
            ...
            error=FormSubmissionErrorContext(
                ...
                context={
                    "type": "error",
                    "title": "forms.rename_feed_subscription.error_title",
        ...
        buttons=FormButtons(
            buttons_container_html_attrs={
                "class": "fb-w-full fb-flex fb-mt-4 fb-items-center fb-gap-2",
                "id": "rename-feed-subscription-form-buttons",
            },
            buttons=[
                Button(
                    text_or_html="""
                    ...
                    <span class="fb-text-xxs fb-font-medium">{{ _t('forms.rename_feed_subscription.submit_btn') }}</span>
                    """,
                    html_attrs={
                        "id": "rename-feed-subscription-form-submit-btn",
                        "type": "submit",
                        "class": "fb-btn fb-btn-primary fb-flex fb-items-center fb-justify-center",
                        "htmx-attrs": [
                ...
                Button(
                    ...
                    html_attrs={
                        "id": "rename-feed-subscription-form-cancel-btn",
                        "type": "button",
