; (function () {
  ...
  function _normalizeLoadingPath(path) {
    return path ? path.split('?')[0].split('#')[0] : path
  }
  ...
  function mayProcessLoadingStateByPath(elt, requestPath) {
    ...
    const expectedPath = _normalizeLoadingPath(pathElt.getAttribute('data-loading-path'))
    const actualPath = _normalizeLoadingPath(requestPath)
